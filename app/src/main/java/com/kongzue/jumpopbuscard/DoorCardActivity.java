...
public class DoorCardActivity extends AppCompatActivity {
            ...
            builder.setPositiveButton("立即下载", new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    if (!goMarket("cn.oneplus.wallet")) {
                        Toast.makeText(DoorCardActivity.this, "未找到可用的应用商店", Toast.LENGTH_SHORT).show();
                        finish();
                    }else{
                        finish();
                    }
    ...
    public boolean openApp() {
        try {
            ...
            intent.setAction("cn.oneplus.wallet.action.MIFARE_LIST");
